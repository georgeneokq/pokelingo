...
public class PetalburgGymSentenceFormingTrainer extends NPC implements Opponent, EventManager.Subscriber {
    ...
    public PetalburgGymSentenceFormingTrainer(float width, float height, TextureAtlas textureAtlas, Texture battleSprite) {
        super(new Rectangle(0, 0, width, height), "Gym Trainer Sasaki", textureAtlas);
    ...
    private void loadAndShuffleQuestions() {
        ...
        QuestionFilter[] questionFilters = new QuestionFilter[] {
            new QuestionFilter((question) -> question.getName().startsWith("sentence_forming"), 0),
        };
